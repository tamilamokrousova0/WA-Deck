(function setupAutoUpdateModule() {
  const RELEASE_NOTES = {
    '0.6.1': [
      'Платформа: Electron 41.2.0 (Chromium 146.0.7680.179, Node.js 24.14.0).',
      'Исправлены сохранение категорий шаблонов и миграция CRM-контактов.',
      'Устранены утечки listener-обработчиков и защита от двойного закрытия модалок.',
      'UI: анимации закрытия, focus-visible, placeholder-стили, унифицированные скроллбары.',
      'Светлая тема и resize-ручка сайдбара доведены, CSS систематизирован через переменные.',
    ],
    '0.5.1': [
